...
// JSON, and license text as emitted local assets rather than keeping a second copy
// here. The Licenses screen loads a selected notice on demand, so the corpus cannot
// drift from what ships and does not inflate the application JavaScript.
import manifest from "../../../desktop/licenses/manifest.json";
import ffmpegNotice from "../../../desktop/licenses/ffmpeg/NOTICE.txt?url&no-inline";
import ffmpegGpl from "../../../desktop/licenses/ffmpeg/COPYING.GPLv3?url&no-inline";
import onnxruntimeNotice from "../../../desktop/licenses/onnxruntime/NOTICE.txt?url&no-inline";
import onnxruntimeLicense from "../../../desktop/licenses/onnxruntime/LICENSE?url&no-inline";
import cudaNotice from "../../../desktop/licenses/cuda/NOTICE.txt?url&no-inline";
...
import wanTi2v5bApache from "../../../desktop/licenses/wan2.2-ti2v-5b/Apache-2.0.txt?url&no-inline";
import wanI2vA14bApache from "../../../desktop/licenses/wan2.2-i2v-a14b/Apache-2.0.txt?url&no-inline";
import wanT2vA14bApache from "../../../desktop/licenses/wan2.2-t2v-a14b/Apache-2.0.txt?url&no-inline";
import ltxLicense from "../../../desktop/licenses/ltx-2.3/LTX-2-Community-License.txt?url&no-inline";
import ltxGemma from "../../../desktop/licenses/ltx-2.3/Gemma-Terms.txt?url&no-inline";
import ltx23IcLorasNotice from "../../../desktop/licenses/ltx-2.3-ic-loras/NOTICE.txt?url&no-inline";
...
import ltx25License from "../../../desktop/licenses/ltx-2.5/LTX-2-Community-License.txt?url&no-inline";
import ltx25GemmaApache from "../../../desktop/licenses/ltx-2.5/Apache-2.0.txt?url&no-inline";
import ltx25GemmaProhibitedUse from "../../../desktop/licenses/ltx-2.5/Gemma-Prohibited-Use-Policy.txt?url&no-inline";
import ltx25Notice from "../../../desktop/licenses/ltx-2.5/NOTICE.txt?url&no-inline";
...
import kokoroApache from "../../../desktop/licenses/kokoro-82m/Apache-2.0.txt?url&no-inline";
import mossApache from "../../../desktop/licenses/moss-soundeffect-v2/Apache-2.0.txt?url&no-inline";
import acestepMit from "../../../desktop/licenses/acestep-v15-turbo/MIT.txt?url&no-inline";
...
import acestepSftCoverMit from "../../../desktop/licenses/acestep-v15-sft-cover/MIT.txt?url&no-inline";
import openvoiceMit from "../../../desktop/licenses/openvoice-v2/MIT.txt?url&no-inline";
...
import chatterboxTtsMit from "../../../desktop/licenses/chatterbox-tts/MIT.txt?url&no-inline";
import chatterboxMit from "../../../desktop/licenses/chatterbox-ve/MIT.txt?url&no-inline";
import chatterboxPerthMit from "../../../desktop/licenses/chatterbox-perth/MIT.txt?url&no-inline";
...
import mossTtsdApache from "../../../desktop/licenses/moss-ttsd-v05/Apache-2.0.txt?url&no-inline";
...
import mmaudioCcByNc from "../../../desktop/licenses/mmaudio/CC-BY-NC-4.0.txt?url&no-inline";
import mmaudioAppleAmlr from "../../../desktop/licenses/mmaudio/Apple-ML-Research-License.txt?url&no-inline";
import mmaudioBigvganMit from "../../../desktop/licenses/mmaudio/MIT.txt?url&no-inline";
// Whisper base (ASR) + LAION CLAP (audio embedder) — Apache-2.0 audio-validation utility models (sc-13684).
import whisperBaseApache from "../../../desktop/licenses/whisper-base/Apache-2.0.txt?url&no-inline";
import clapHtsatApache from "../../../desktop/licenses/clap-htsat-unfused/Apache-2.0.txt?url&no-inline";
...
import animaCircleStoneLabsNonCommercialLicense from "../../../desktop/licenses/anima/CircleStone-Labs-Non-Commercial-License.txt?url&no-inline";
import berniniApache20 from "../../../desktop/licenses/bernini/Apache-2.0.txt?url&no-inline";
import booguImageApache20 from "../../../desktop/licenses/boogu-image/Apache-2.0.txt?url&no-inline";
import chroma1Apache20 from "../../../desktop/licenses/chroma1/Apache-2.0.txt?url&no-inline";
import flux1DevFLUX1DevNonCommercialLicense from "../../../desktop/licenses/flux1-dev/FLUX.1-dev-Non-Commercial-License.txt?url&no-inline";
import flux1SchnellApache20 from "../../../desktop/licenses/flux1-schnell/Apache-2.0.txt?url&no-inline";
import flux2DevFLUX2DevNonCommercialLicense from "../../../desktop/licenses/flux2-dev/FLUX.2-dev-Non-Commercial-License.txt?url&no-inline";
import flux2KleinFLUXNonCommercialLicense from "../../../desktop/licenses/flux2-klein/FLUX-Non-Commercial-License.txt?url&no-inline";
import ideogram4IdeogramNonCommercialModelAgreement from "../../../desktop/licenses/ideogram-4/Ideogram-Non-Commercial-Model-Agreement.txt?url&no-inline";
import illustriousXlV1CreativeMLOpenRAILM from "../../../desktop/licenses/illustrious-xl-v1/CreativeML-Open-RAIL++-M.txt?url&no-inline";
import illustriousXlV2CreativeMLOpenRAILM from "../../../desktop/licenses/illustrious-xl-v2/CreativeML-Open-RAIL-M.txt?url&no-inline";
import kolorsKolorsModelLicense from "../../../desktop/licenses/kolors/Kolors-Model-License.txt?url&no-inline";
...
import sdxlCreativeMLOpenRAILM from "../../../desktop/licenses/sdxl/CreativeML-Open-RAIL++-M.txt?url&no-inline";
import sensenovaU1Apache20 from "../../../desktop/licenses/sensenova-u1/Apache-2.0.txt?url&no-inline";
import zImageApache20 from "../../../desktop/licenses/z-image/Apache-2.0.txt?url&no-inline";
import ltx23ErosLTX2CommunityLicense from "../../../desktop/licenses/ltx-2.3-eros/LTX-2-Community-License.txt?url&no-inline";
import kreaRealtimeApache20 from "../../../desktop/licenses/krea-realtime/Apache-2.0.txt?url&no-inline";
...
import minimaxH3Notice from "../../../desktop/licenses/minimax-h3/NOTICE.txt?url&no-inline";
import minimaxH3CommunityLicense from "../../../desktop/licenses/minimax-h3/MiniMax-H3-Community-License.txt?url&no-inline";
import minimaxH3QwenApache20 from "../../../desktop/licenses/minimax-h3/Apache-2.0.txt?url&no-inline";
import wan21VaeApache20 from "../../../desktop/licenses/wan2_1_t2v_14b_diffusers/Apache-2.0.txt?url&no-inline";
import scail2MIT from "../../../desktop/licenses/scail2/MIT.txt?url&no-inline";
import svdStableVideoDiffusionCommunityLicense from "../../../desktop/licenses/svd/Stable-Video-Diffusion-Community-License.txt?url&no-inline";
import wan22VaceFunApache20 from "../../../desktop/licenses/wan2.2-vace-fun/Apache-2.0.txt?url&no-inline";
import auraSrV2Apache20 from "../../../desktop/licenses/aura-sr-v2/Apache-2.0.txt?url&no-inline";
import sam3License from "../../../desktop/licenses/sam3/SAM-License.txt?url&no-inline";
import sam2Apache20 from "../../../desktop/licenses/sam2/Apache-2.0.txt?url&no-inline";
import yolo11Agpl30 from "../../../desktop/licenses/yolo11/AGPL-3.0.txt?url&no-inline";
import controlnetTileSdxlApache20 from "../../../desktop/licenses/controlnet-tile-sdxl/Apache-2.0.txt?url&no-inline";
import pidNVIDIALicense from "../../../desktop/licenses/pid/NVIDIA-License.txt?url&no-inline";
import realEsrganBSD3Clause from "../../../desktop/licenses/real-esrgan/BSD-3-Clause.txt?url&no-inline";
import qwen3VlCaptionApache20 from "../../../desktop/licenses/qwen3-vl-caption/Apache-2.0.txt?url&no-inline";
import seedvr2Apache20 from "../../../desktop/licenses/seedvr2/Apache-2.0.txt?url&no-inline";
...
import dwposeApache20 from "../../../desktop/licenses/dwpose/Apache-2.0.txt?url&no-inline";
...
import insightfaceModelNotice from "../../../desktop/licenses/insightface/InsightFace-Model-License-Notice.txt?url&no-inline";
...
// their keys here. Vite emits these with the app instead of embedding the full corpus in JavaScript.
const DOCUMENT_URL = {
...
export const bundledLicenses = (manifest.components ?? []).map((component) => ({
  ...
  documents: (component.documents ?? [])
    .map((doc) => ({ key: doc.key, label: doc.label, url: DOCUMENT_URL[doc.key] }))
    .filter((doc) => typeof doc.url === "string"),
}));
