...
_MODELS = {
    ...
    # sc-1975 patch: SDXL base 1.0 (same HF file layout as sdxl-turbo).
    # SceneWorks's MODEL_TARGETS["sdxl"] resolves to this repo via the
    # existing torch SdxlDiffusersAdapter; mirror it here so MlxSdxlAdapter
    # can resolve the same weights from the shared HF cache without a
    # second download. Re-apply this block on any upstream re-vendor (see
    # _vendor/mlx_sd/README.md "Re-vendor recipe").
