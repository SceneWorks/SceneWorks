...
convention of raising very small configured learning rates to `1.0`. Override PEFT
target modules per job via `config.advanced.loraTargetModules` when a base model
names its attention layers differently.
