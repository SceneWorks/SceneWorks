...
/// non-MLX model, and extend/bridge on the Wan engines (no IC-LoRA keyframe-append path).
...
/// `replace_person` rides the Wan-VACE path and is a separate cutover slice.
