...
impl ResolvedCacheStore {
    ...
    /// Inspect an already-initialized cache without creating a runtime session or refreshing usage.
    /// Missing cache roots are an empty cache; unmanaged or invalid roots still fail closed.
