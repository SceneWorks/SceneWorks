...
const T2V_A14B: Arm = Arm {
    ...
    packed: Family {
        ...
        repository: "SceneWorks/wan2.2-t2v-a14b-candle",
        layout: Layout::Tiered,
    },
    dense: Some(Family {
...
const I2V_A14B: Arm = Arm {
    ...
    packed: Family {
        ...
        repository: "SceneWorks/wan2.2-i2v-a14b-candle",
        layout: Layout::Tiered,
    },
    dense: Some(Family {
        ...
        repository: "Wan-AI/Wan2.2-I2V-A14B-Diffusers",
        layout: Layout::Flat,
    }),
