 ...
 * edge, not one — `crates/contracts/gen-core/src/memory_strategy.rs:1468-1481` at pinned
 * `014134e3`. The first is `engages`; the second is that the prerequisite rung is declared
