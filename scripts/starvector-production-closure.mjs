...
export const PRODUCTION_CLOSURE_PATHS = Object.freeze([
  ...
  "crates/sceneworks-worker/src/bin/starvector_terminal_corpus.rs",
  ...
  "scripts/lib/starvector-terminal-limit-cases.json",
  "scripts/lib/starvector-terminal-limit-cases.mjs",
  ...
  "scripts/starvector-terminal-components.mjs",
  ...
  "scripts/starvector-terminal-readiness.mjs",
