...
test("exact pinned validator accepts sealed golden receipt and rejects every gate mutation", async () => {
  ...
  await assert.rejects(() => sealReceipt({ sceneWorksRoot, planPath: path.join(process.cwd(), "release/starvector-terminal-campaign-v1.json"), inferenceRoot, evidenceRoot: evidence, output, campaignRunId: "campaign", permanentPin }), /canonical artifact digest mismatch/);
