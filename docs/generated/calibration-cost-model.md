...
- Matrix revision: `source-tree:71395e664969a4eeaa675a238be7daa98886a85876f30152ac7ae15f94d78c8d`
- Inference revision: `d48023204cd3a4f3f8eb060f79803dccaddcb482`
...
Completed-evidence baseline: 33 complete record(s) exist in the evidence bundle; the matrix reports 5 current calibration run(s) and 5 aggregate Verified cell(s). Exact records remain narrower than aggregate matrix cells, so a current exact run does not by itself promote a whole cell.
