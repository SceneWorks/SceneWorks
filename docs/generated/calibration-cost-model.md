...
- Matrix revision: `source-tree:027f103e09818c8fca7dfae312e651a8203b33391948c5b67cc3dcb6df12119b`
- Inference revision: `09aefe3afb125af3f0736d55a438c412d64ec4c2`
...
**`overlay-declined` is charged 4564 cells by the first-match partition, but it is the SOLE blocker on 30 of them. 4360 of them (95.5%) are also blocked by having NO PROVIDER ADAPTER AT ALL, and the remaining 174 by an adapter that has never emitted a `complete` record. Charge adapter coverage first and the overlay bucket falls to 204 while `no-provider-adapter` rises to 7000. PROVIDER-ADAPTER COVERAGE, not overlay support, is the largest independent blocker: it is the only thing wrong with 2640 cells and it touches 7000. Closing the remaining overlay-support gaps is still necessary, but on its own it moves 204 cells, not 4564.**
