...
- Matrix revision: `source-tree:5687406dc05b49aaeb7246c88e2f88ac6ff22f71167c41b727ac1d4bd841a97d`
...
Completed-evidence baseline: 28 complete record(s) exist in the evidence bundle; the matrix reports 4 current calibration run(s) and 4 aggregate Verified cell(s). Exact records remain narrower than aggregate matrix cells, so a current exact run does not by itself promote a whole cell.
