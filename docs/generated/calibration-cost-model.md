...
- Matrix revision: `source-tree:fc89014f932a68f606ef77c0c3f951c4d358131db11fef597263d265810156ad`
...
Geometry is already collapsed: keyed per advertised resolution the matrix would hold **44670** cells, so the published count embeds a **6.069x** collapse.
...
| --- | --- | --- |
| `exhaustive-exact-geometry` | 8934 | 44670 |
...
`geometryPointsPerFit`, `slopeSharedAcrossTiers` and `validationSampleFraction` were the only parameters in this model that were fixed rather than swept, which contradicted its own stated policy. Swept here. The exact-geometry/fit ratio ranges **1.43x–4.49x** across the grid, so the headline `2.96x` is one point on a surface.

| geometry points | slope shared | validation sample | Fit loads | Validation loads | Total loads | exact/fit | fit/per-cell |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | false | 0 | 2944 | 0 | 2944 | 3.03x | 2x |
| 2 | false | 0.05 | 2944 | 74 | 3018 | 2.96x | 2.05x |
| 2 | false | 0.25 | 2944 | 368 | 3312 | 2.7x | 2.25x |
| 2 | true | 0 | 1988 | 0 | 1988 | 4.49x | 1.35x |
| 2 | true | 0.05 | 1988 | 74 | 2062 | 4.33x | 1.4x |
| 2 | true | 0.25 | 1988 | 368 | 2356 | 3.79x | 1.6x |
| 3 | false | 0 | 4416 | 0 | 4416 | 2.02x | 3x |
| 3 | false | 0.05 | 4416 | 74 | 4490 | 1.99x | 3.05x |
| 3 | false | 0.25 | 4416 | 368 | 4784 | 1.87x | 3.25x |
| 3 | true | 0 | 2504 | 0 | 2504 | 3.57x | 1.7x |
| 3 | true | 0.05 | 2504 | 74 | 2578 | 3.47x | 1.75x |
| 3 | true | 0.25 | 2504 | 368 | 2872 | 3.11x | 1.95x |
| 4 | false | 0 | 5888 | 0 | 5888 | 1.52x | 4x |
| 4 | false | 0.05 | 5888 | 74 | 5962 | 1.5x | 4.05x |
| 4 | false | 0.25 | 5888 | 368 | 6256 | 1.43x | 4.25x |
| 4 | true | 0 | 3020 | 0 | 3020 | 2.96x | 2.05x |
| 4 | true | 0.05 | 3020 | 74 | 3094 | 2.89x | 2.1x |
| 4 | true | 0.25 | 3020 | 368 | 3388 | 2.64x | 2.3x |
