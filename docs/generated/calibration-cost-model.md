...
- Matrix revision: `source-tree:85f8b9d6bd94a918e8f562ff0c3d3056162adeebc373ee68ebdfc2f7bd6f6e5f`
- Inference revision: `96b13b6630132410a29ae1bcdf4d8738db7af28a`
...
Completed-evidence baseline: 2 complete record(s) exist in the evidence bundle; the matrix reports 2 current calibration run(s) and 0 aggregate Verified cell(s). Exact records remain narrower than aggregate matrix cells, so a current exact run does not by itself promote a whole cell.
