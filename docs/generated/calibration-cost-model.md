...
- Matrix revision: `source-tree:794defe6e4900cf8dfbc7d2820a3f10d7b96d24f55577bcebe4990f46057512c`
- Inference revision: `cc5b30a92ab5b0789afee71e38891aa15b8e5357`
...
Completed-evidence baseline: 114 complete record(s) exist in the evidence bundle; the matrix reports 0 current calibration run(s) and 0 aggregate Verified cell(s). Exact records remain narrower than aggregate matrix cells, so a current exact run does not by itself promote a whole cell.
