...
- SceneWorks revision: `source-tree:2b3918cffd38e603f3a934229ee46948c3817b9710f5a0e4ed0ead7744c5c3d5`
...
- Base-only runtime-complete calibration records: 10
...
| `flux_dev` | candle | `flux1_dev` (registry) | SC-15823 | SC-15898 | Runtime verified |
| `flux_schnell` | mlx | `flux1_schnell` (registry) | SC-15514 | SC-15470 | Implemented/unverified |
| `flux_schnell` | candle | `flux1_schnell` (registry) | SC-15823 | SC-15895 | Runtime verified |
...
| SC-15519 | candle | partial | none | unmeasured |
