...
`7410dea8364f184dbbb07a37c77c1c00e6039a23`.
...
| q4 | streamed transformer | 13.559 warm high-water | 2.016 | 13.7 |
| q8 | resident | 32.050 | 32.050 | 32.1 |
| q8 | staged | 19.836 | 15.675 | 19.9 |
| q8 | bounded decode | 19.836 | 14.232 | 19.9 |
| q8 | bounded attention | 16.009 | 14.230 | 16.1 |
| q8 | streamed transformer | 13.297 | 2.922 | 13.8 |
...
| bf16 | streamed transformer | 13.096 | 2.956 | 13.4 |
...
- LoRA: every tier runs resident and streamed-transformer with two fixed-seed warm repeats. Each run
  reloads an unadapted generator and requires adapted output to differ. Optimized admission adds the
...
- Style/reference: every tier runs two identical warm reference-conditioned generations and a plain
...
lifecycle test transcript, and one negative-mutation comparison. Each record names sources separately for
