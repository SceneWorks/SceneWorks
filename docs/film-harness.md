...
non-goals. [film-harness-ui-integration.md](film-harness-ui-integration.md) is the design note for a
future Video Editor front end: the library/CLI/route layering, the run record as the single state
document, and the open questions that epic has to settle.
